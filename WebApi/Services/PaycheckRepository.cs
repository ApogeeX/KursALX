...
namespace WebApi.Services
{
    ...
    {
        private const string _connectionString = "Data Source=EMIL\\SQLEXPRESS;Initial Catalog=WebCompany;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
